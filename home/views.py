...
db = mysql.connector.connect(
    host="Prince7126.mysql.pythonanywhere-services.com",
    user="Prince7126",
    password="abcd123456A1",
    database="Prince7126$Signup_data"
    )
...
def signup(request):
    if request.method == "POST":
        ...
        mycursor.execute("INSERT INTO signup(email,username,phone) VALUES(%s,%s,%s,%s)" , (email,username,number))
        db.commit()
